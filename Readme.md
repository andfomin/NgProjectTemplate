...
* Modify the existing Startup.cs file.
   ...
   Insert the following code snippet in the Configure method at the end of the method in an WebAPI, MVC or Razor Pages project or before "app.Run(...)" in an Empty project. If no existing "app.UseStaticFiles()" call was found in the Configure method, insert a "app.UseStaticFiles();" line before "app.UseNgRoute();" in the code snippet.
